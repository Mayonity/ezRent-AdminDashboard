      ...
      <div className='flex items-center rounded-xl justify-center bg-white shadow w-200'>
        ...
        <div className={` new form  rounded-xl    flex flex-col justify-center px-6 py-12 lg:px-8 bg-${themes.white} ease-in-out duration-500 ${showContent ? 'opacity-100' : 'opacity-0'}`} style={{ height: '600px' }}>
          <div className="sm:mx-auto sm:w-full sm:max-w-sm">
            <h2 className={`mt-10 text-4xl font-bold font leading-9 one tracking-tight new text-black ease-in-out ml-3 duration-500 ${showContent ? 'opacity-100' : 'opacity-0'}`}>Login</h2>
          </div>
            ...
            <form className="space-y-6" action="#" method="POST">
              ...
              <div>
                ...
                <div className="mt-2 relative">
                  ...
                  {/* <HiOutlineEyeOff className="absolute top-4 right-[-90px] text-graydark text-xl" onClick={togglePasswordVisiblity} /> */}
                </div>
              </div>
              <div>
                <button
