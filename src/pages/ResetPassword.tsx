        ...
        <div className="flex flex-col justify-center items-center h-screen ">
          ...
          <div className="md:w-[600px] md:mx-auto m-5 bg-white rounded-2xl ">
            ...
            <div className=" w-[80%] mx-auto text-center space-y-6 py-12">
              ...
              <input type="password" onChange={(e) => setPassword(e.target.value)} placeholder="New Password" className="w-full text-xs  focus:border-[#0E9F6E] outline-none border-2 border-[#DCDCDC] rounded-md p-3 " />
              <input type="password" onChange={(e) => setConfirmPassword(e.target.value)} placeholder="Confirm Password" className="w-full  text-xs focus:border-[#0E9F6E] outline-none border-2 border-[#DCDCDC] rounded-md p-3 " />
