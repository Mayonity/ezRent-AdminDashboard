const Card2 = () => {
  return (
    <div className='bg-yellow lg:w-full md:w-59 rounded-lg h-25 flex space-x-9 md:space-x-5 p-5 mb-4 md:mb-0'>
      <div className="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-yellowlight dark:bg-lightblue">
