...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ...
      ref={sidebar}
      className={`absolute left-0  top-0 z-9999 flex  w-72.5 flex-col  bg-white  pb-50 duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'
        }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
            ...
            <ul className="mb-6 flex flex-col gap-3.5">
              <li>
                <NavLink
                  to="/Dashboard"
                  style={{
                    color: pathname.includes('/Dashboard') ? '#1D9E6F' : 'gray',
                  }}
                  className={`group t relative flex items-center gap-2.5 text-gray-2 rounded-sm py-2 px-4 font-medium cursor-pointer 
                  ...
                  <svg
                    ...
                    height="24"
                    viewBox="0 0 24 24"
                    fill={pathname.includes('/Dashboard') ? '#1D9E6F' : 'none'}
              ...
              <li>
                <NavLink
                  to="/Users"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium duration-300 ease-in-out hover:text-meta-3  ${pathname.includes('profile') && 'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <svg
              ...
              <li>
                <NavLink
                  to="/Categories"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium duration-300 ease-in-out hover:text-meta-3  ${pathname.includes('tables') && 'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <svg
                    width="24"
              ...
              <li>
                <NavLink
                  to="/Products"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-gray-2 duration-300 ease-in-out hover:text-meta-3  ${pathname.includes('settings') && 'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                <NavLink
                  to="/Chats"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-gray-2 duration-300 ease-in-out hover:text-meta-3  ${pathname.includes('/Chats') && 'text-meta-3' // Set text color based on active state
                ...
                >
                  <span className="group relative flex items-center gap-2.5">
                    <svg
                      ...
                      className={`orders hover:stroke-meta-3 text-gray-2 ${pathname.includes('/Chats') ? 'text-meta-3' : '' // Apply hover effect and text color when active
                        }`}
                    >
                      <path
              ...
              <li>
                <NavLink
                  to="/Reports"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium duration-300 ease-in-out ${pathname.includes('/Reports') ? 'text-meta-3 hover:text-meta-3' : 'text-gray-2 hover:text-meta-3'
                    } ${pathname.includes('tables') && 'bg-graydark dark:bg-meta-4'}`}
                >
              ...
              <li>
                <NavLink
                  to="/Transaction"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium duration-300 ease-in-out ${pathname.includes('/Transaction') ? 'text-meta-3 hover:text-meta-3' : 'text-gray-2 hover:text-meta-3'
                    } ${pathname.includes('tables') && 'bg-graydark dark:bg-meta-4'}`}
                >
                  <svg width="24" height="24" viewBox="0 0 24 24"
                    fill={pathname.includes('/Transaction') ? '#1D9E6F' : 'none'}
                    xmlns="http://www.w3.org/2000/svg">
                ...
                >
                  {(handleClick, open) => (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-gray-2  hover:text-meta-3 ${(pathname === '/' || pathname.includes('dashboard')) &&
                      ...
                      >
                        <svg
                          ...
                          xmlns="http://www.w3.org/2000/svg"
                          stroke="#787878"
                          className="orders hover:fill-meta-3 text-gray-2"
                        >
                          {/* SVG Path */}
