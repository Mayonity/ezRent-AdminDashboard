  ...
  return (
    ...
    <div>
      ...
      <div className="w-[681px]  shrink-0 border pb-6 rounded-[10px] bg-white border-solid border-[#CACACA] " style={{ maxWidth: '180%', width: '100%', margin: '0 auto' }}>
        <h1 className='text-xl text-gray-2 pl-10 opacity-90 mt-6'>Total Users</h1>
        <br />
        <div className='p-6'>
          <div className='flex'>
            <div className="text-[#787878] text-xl font-bold not-italic" style={{ writingMode: 'vertical-rl', transform: 'rotate(-180deg)', marginBottom: '50px' }}>
              Number of Users
            </div>
          ...
          <div className='text-[#787878] text-center text-xl not-italic font-bold leading-[normal] mt-25'>March 2023</div>
        </div>
      </div>
    </div>
