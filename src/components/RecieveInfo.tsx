  ...
  return (
    ...
    <div className=" sm:mx-auto sm:w-full sm:max-w-sm">
     ...
     <div className='-ml-30'>
        ...
        <input type="password" placeholder='John Doe' className='p-3 w-125 mt-3 mb-5 rounded-md border border-2 border-box text-box ml-5' />

        <label htmlFor="" className='ml-5 mt-5'>Phone Number</label>

        <input type="password"  className='p-3 w-125 mt-3 rounded-md  border-2  border-box text-box ml-5 ' />
